...
for SNR in [-18, -15, -12, -9, -6, -3, 0, 3, 6, 9, 12, 15, 18]:
    ...
    input_folder = f"/disk4/chocho/_datas/VCTK_DEMAND16k-SNR/noisy/{SNR}"  # Replace with your input folder path
    output_folder = f"/disk4/chocho/_enhanced-wav/DCCRN/{SNR}"
