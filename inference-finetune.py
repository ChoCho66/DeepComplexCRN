...
checkpoint_path = "checkpoints/dccrn_finetune_on_THCHS30_epoch2.pt"
checkpoint = torch.load(checkpoint_path, map_location=device)
model.load_state_dict(checkpoint["model"])
print(f"Loaded model weights from {checkpoint_path}")

# for SNR in [2,1,0,-1,-5,-10]:
# for SNR in [-12, -10, -8, -5, -3, -1, 0, 1, 2, 2.5, 7.5, 12.5, 17.5]:
# for SNR in [-18, -15, -12, -9, -6, -3, 0, 3, 6, 9, 12, 15, 18]:
for noise in ['cafe','car','white']:
    # Input and output directories
    input_folder = f"/disk4/chocho/_datas/THCHS-30/test-data1/test-noise1/{noise}"  # Replace with your input folder path
    output_folder = f"/disk4/chocho/_enhanced-wav/THCHS-30/DCCRN-finetune/{noise}"
