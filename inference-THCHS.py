...
for noise in ['cafe','car','white']:
    ...
    input_folder = f"/disk4/chocho/_datas/THCHS-30/test-noise1/{noise}"  # Replace with your input folder path
    output_folder = f"/disk4/chocho/_enhanced-wav/THCHS-30/DCCRN/{noise}"
